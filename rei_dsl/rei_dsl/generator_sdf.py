...
class SdfGenerator(AbstractRobotFormatGenerator):
    ...
    def generate_format(self):
        ...
        model_root = etree.SubElement(sdf_root, "model")
        model_root.attrib["name"] = robot.name
        # Add links
        for link in robot.links.values():
            link_element = etree.SubElement(model_root, "link")
        ...
        for joint in robot.joints.values():
            joint_element = etree.SubElement(model_root, "joint")
